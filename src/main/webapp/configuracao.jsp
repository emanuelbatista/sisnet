                        ...
                        <ul class="lista">
                            ...
                            <li>
                                <form action="adicionar-local-trabalho" method="post">
                                    <input type="text" required pattern="[A-ZÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑa-záàâãéèíïóôõöúçñ].*[^\s]$" name="local-trabalho" placeholder="Digite um local de Trabalho">
                                    <br>
                                    <br>
                        ...
                        <ul class="lista">
                            ...
                            <li>
                                <form action="adicionar-local-estudou" method="post">
                                    <input type="text" required pattern="[A-ZÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑa-záàâãéèíïóôõöúçñ].*[^\s]$" name="local-estudou" placeholder="Digite onde Estudou">
                                    <br>
                                    <br>
                                    <input type="submit" value="Add">
                                </form>
