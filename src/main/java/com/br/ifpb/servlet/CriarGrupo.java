 ...
 */
@WebServlet(name="CriarGrupo", urlPatterns={"/criar-grupo"})
public class CriarGrupo extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(usuario!=null){
            ...
            try {
                gerenciarGrupo.criar(nome, descricao, usuario);
                Grupo grupo=gerenciarGrupo.ultimoGrupo();
                gerenciarGrupo.participarDoGrupo(grupo.getId(), usuario.getId());
