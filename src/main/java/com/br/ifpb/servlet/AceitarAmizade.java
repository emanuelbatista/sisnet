 ...
 */
@WebServlet(name = "AceitarAmizade", urlPatterns = {"/aceitar-amizade"})
public class AceitarAmizade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario != null && idParametro != null) {
            ...
            try {
                gerenciarAmizade.aceitarSolicitacao(usuario.getId(), idParametro);
