 ...
 */
@WebServlet(name = "DesfazerRelacao", urlPatterns = {"/desfazer-relacao"})
public class DesfazerRelacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario != null && idParametro != null) {
            ...
            try {
                gerenciarRelacao.desfazerRelacao(usuario.getId(), idParametro);
            } catch (PersistenciaException ex) {
                Logger.getLogger(DesfazerRelacao.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
